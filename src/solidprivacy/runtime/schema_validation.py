...
def validate_review_decision(instance: Any) -> None: validate_contract("review_decision.schema.json", instance)
def validate_dpia_review_request(instance: Any) -> None: validate_contract("dpia_review_request.schema.json", instance)
def validate_dpia_review_decision_set(instance: Any) -> None: validate_contract("dpia_review_decision_set.schema.json", instance)
def validate_review_audit_record(instance: Any) -> None: validate_contract("review_audit_record.schema.json", instance)
def validate_dpia_review_package(instance: Any) -> None: validate_contract("dpia_review_package.schema.json", instance)
